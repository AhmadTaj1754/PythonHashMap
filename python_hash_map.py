...
hasher_map= HashMap(4)
hasher_map.assign('Name', 'Ahmad Taj')
hasher_map.assign('Height', '350cm')
hasher_map.assign('weight', '185lbs')
hasher_map.assign('business', 'computers')

print(hasher_map.retrieve('Name'))
print(hasher_map.retrieve('Height'))
print(hasher_map.retrieve('weight'))
print(hasher_map.retrieve('business'))
